...
// import { getAllTestimonials } from "@/lib/testimonials.utils";
      ...
      <section className="relative py-14">
        <div className="relative z-10 mx-auto max-w-screen-xl px-4 md:px-8">
          <div className="max-w-xl sm:text-center md:mx-auto">
            <h3 className="text-3xl font-semibold text-gray-800 dark:text-gray-100 sm:text-4xl">
              Hear from our customers
            </h3>
            <p className="mt-3 text-gray-600 dark:text-gray-300">
              We&apos;ve served customers from different sources. Some of our clients connect us from different
              freelance marketplaces. We&apos;ve successfully served all our customers with satisfactions.
            </p>
          </div>
          <div className="mt-12">
            <Carousel className="max-w-screen w-full">
              ...
              <CarouselContent>
                {approvedTestimonials &&
                  approvedTestimonials.map((testimonial, indx) => (
                    <CarouselItem key={indx} className="md:basis-1/2 lg:basis-1/3">
                        ...
                        <Card className="flex h-full w-full flex-col justify-between">
                          ...
                          <figure>
                            <CardContent>
                              ...
                              <CardTitle></CardTitle>
                              <CardDescription>{testimonial.clientName}</CardDescription>
                            </CardContent>
                            <CardFooter>{testimonial.companyName}</CardFooter>
                          </figure>
                        </Card>
                      </Link>
                    </CarouselItem>
